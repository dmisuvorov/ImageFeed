...
func equal<Anchor, Axis>(_ keyPath: KeyPath<UIView, Anchor>, to constant: CGFloat) -> Constraint where Anchor: NSLayoutAnchor<Axis> {
...
func equal<Anchor, Axis>(_ from: KeyPath<UIView, Anchor>, _ to: KeyPath<UIView, Anchor>, to constant: CGFloat) -> Constraint where Anchor: NSLayoutAnchor<Axis> {
    return { view, parent in
        view[keyPath: from].constraint(equalTo: parent[keyPath: to], constant: constant)
    }
}

func equal<Anchor, Axis>(_ from: KeyPath<UIView, Anchor>, _ to: Anchor, to constant: CGFloat) -> Constraint where Anchor: NSLayoutAnchor<Axis> {
    return { view, _ in
